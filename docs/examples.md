...
# NOTE: I've found that bumping the result limit to 500 (from the default 250) helps avoid
# missing edge cases — especially useful when exploring scaffold diversity early in a campaign.
```
